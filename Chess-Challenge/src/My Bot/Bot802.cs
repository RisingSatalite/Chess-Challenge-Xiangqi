...
public class MyBot802: IChessBot
{
    //using Bot 404
    ...
    public Move Think(Board board, Timer timer)
    {
        ...
        foreach (Move possibleMoves in allMoves)
        {
            ...
            Console.WriteLine(MoveTakePower(board, possibleMoves).ToString());
            Console.WriteLine(MaxDangerDetection(board, possibleMoves).ToString());
            int other = FutureAttackTotal(board, possibleMoves) + MateAble(board, possibleMoves) + MoveTakePower(board, possibleMoves) - MaxDangerDetection(board, possibleMoves);
            Console.WriteLine("What i got");
            Console.WriteLine(currentScore.ToString());
            Console.WriteLine("What it should be");
    ...
    private int MoveCalculater(Board board, Move move)
    {
        ...
        Console.WriteLine(((overallTakingPower + 1) / 50).ToString());
        Console.WriteLine(((takingPower + 1) / (counterMoves.Length * 10)).ToString());
        Console.WriteLine(checkmatePotentail.ToString());
        Console.WriteLine(imediateTake.ToString());
