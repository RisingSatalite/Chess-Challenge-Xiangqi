...
//This bot is aggresive and more willing to trade to a draw
public class MyBot305argo : IChessBot
{
    ...
    public Move Think(Board board, Timer timer)
    {
        ...
        foreach (Move possibleMoves in allMoves)
        {
            ...
            int currentScore = MoveTakePower(board, possibleMoves) - MaxDangerDetection(board, possibleMoves);
    ...
    {
        int[] pieceValues = { 0, 200, 600, 600, 1000, 1800, 200000 };
