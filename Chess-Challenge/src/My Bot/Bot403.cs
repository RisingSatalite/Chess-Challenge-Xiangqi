...
//It search which move after can lead to the greatest capture potentail
public class MyBot403 : IChessBot
{
    ...
    public Move Think(Board board, Timer timer)
    {
        ...
        foreach (Move possibleMoves in allMoves)
        {
            ...
            int currentScore = FutureAttack(board, possibleMoves) + MateAble(board, possibleMoves) + MoveTakePower(board, possibleMoves) - MaxDangerDetection(board, possibleMoves);
